...
public class ScoreCounterLoader : MonoBehaviour
{
    private void Start()
    {
...
public static class ScoreRecorder
{
    ...
    public static LevelHighScoreRecord GetRecord(string levelAssetBundle)
    {
    ...
    public static bool Record(string levelNameAssetBundle, LevelHighScoreRecord score)
    {
...
[Serializable]
public class LevelHighScoreRecord
{
